...
if ($posttype != 4) {
    ...
    if ($return != 1) {
	$returnurl = _addFdGetToLink(_addGetToLink($_GET['_return'], "replyto=" . $xhome, false), array("guest" => $guest, "subject" => $_POST['subject'], "text" => $_POST['text'])) . "&addpost";
    } else {
	$returnurl = $_GET['_return'];
    }
