...
$(document).ready(function(){
    ...
    // get path to codemirror's dir
    var path = 'modules/codemirror/';

    $('body textarea.codemirror').each(function(){

        // determine syntax type
        if(jQuery(this).hasClass('xml')) {
            type = 'xml';
        } else {
            return;
        }
        ...
        CodeMirror.fromTextArea(this, {
            ...
            parserfile: "parse"+type+".js",
            stylesheet: path+type+"colors.css",
            path: path,
