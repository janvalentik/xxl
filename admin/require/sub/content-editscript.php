...
<td><textarea name='intersectionperex' rows='2' cols='94' class='arealine'>"._htmlStr($query['intersectionperex'])."</textarea></td>
</tr>
...
<td>
".(($type!=6)?
"<textarea name='content' rows='25' cols='94' class='areabig' id='wysiwygtarget'>"._htmlStr($query['content'])."</textarea>":
