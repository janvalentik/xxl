...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template name="siteindexTable">         
    <h2>Počet URL v Sitemap: <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"></xsl:value-of></h2>          
  ...
  <xsl:template name="sitemapTable">          
    <h2>Počet URL v Sitemap: <xsl:value-of select="count(sitemap:urlset/sitemap:url)"></xsl:value-of></h2>
